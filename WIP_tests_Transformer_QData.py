...
from data_to_qdata import preprocess_and_save
import itertools
...
if __name__ == "__main__":
    try:
        ...
        # Transform to Quantum_Data

        QuantumDataLoaders = preprocess_and_save( B = B )
        shape = QuantumDataLoaders[-1]
        ...
        print(f"Shape of the Quantum Dataset: {shape}")
        ...
        for idx in range(NExperiments):
            ...
            for filter_config in ['none', 'filter']:
                ...
                test_auc, test_acc, val_auc, val_acc, train_auc, train_acc, params = qpctorch.training.train_and_evaluate(
                    model, QuantumDataLoaders[0], QuantumDataLoaders[1], QuantumDataLoaders[2], num_classes=7,
