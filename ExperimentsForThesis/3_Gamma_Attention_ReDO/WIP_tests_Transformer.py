...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/special_cls_and_dropout',
        'experiment_name': '3_Gamma_Attention_Dropout',
        'B': 256,
        'N': 125, # Num epochs
        'num_experiments': 100,
        'num_classes': 7,
    ...
    model_iter = {
        'special_cls': ['replace_attention', 'partial_projection', 'full_projection', 'false'], 'dropout': [0.175, 0.275]
    }
