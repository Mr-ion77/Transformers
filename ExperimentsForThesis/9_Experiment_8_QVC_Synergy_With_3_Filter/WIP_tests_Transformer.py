...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/q_train_crx_train_high_mlp_filter_synergy',
        'experiment_name': '9_Experiment_8_QVC_Synergy_With_3_Filter',
        'B': 256,
        'N': 100, # Num epochs
        'num_experiments': 50,
        'num_classes': 7,
    ...
    model_iter = {
        'quantum' : [False, True], 'U3_layers' : [0, 1, 2], 'entangling_layers' : [0, 1, 2], 'selection_amount': [49, 30, 20]
    }
