...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/q_stride',
        'experiment_name': 'Q stride effect',
        'B': 256,
        'N': 125, # Num epochs
        'num_experiments': 30,
        'num_classes': 7,
    ...
    agg, top_n = aggregate_and_save_top_configs(df = df_results, group_cols = group_cols, value_column = value_column, table_dir = table_dir, n=4)
