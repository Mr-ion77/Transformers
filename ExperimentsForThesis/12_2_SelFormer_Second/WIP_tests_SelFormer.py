...
p1 = {
    '1_learning_rate': 0.0025, '1_hidden_size': 64*3, '1_dropout': 0.285,
    '1_quantum' : False, '1_num_head': 16, '1_Attention_N' : 2, '1_num_transf': 2, '1_mlp_size': 7, '1_patch_size': 8, '1_weight_decay': 1e-7, '1_attention_selection': 'filter', 
    '1_selection_amount': 20, '1_RD': 1, '1_connectivity' : graph ,'1_entangle_method' : 'edges', '1_special_cls' : 'none', '1_parallel': 1, '1_patience': -1, 
...
w = torch.pi/3
data = {
    'connectivity' : {'edges': [[0, 1], [1, 2], [2, 3], [3, 0], [0, 2], [1, 3]], 'weights': [w,w,w,w,w,w]} ,'entangle_method' : 'CRX', 'ancilla' : 0, 'channels_out' : [1], 'selection_amount': 30,
    'flatten_extra_channels' : False, 'quanv_kernel_size' : 2, 'invert_embedding' : True    
}

p2 = {
    'learning_rate': 0.00125, 'hidden_size': 64*3, 'dropout': 0.175,
    'quantum' : False, 'num_head': 16, 'Attention_N' : 2, 'num_transf': 2, 'mlp_size': 6, 'patch_size': 8, 'weight_decay': 1e-4, 'attention_selection': 'filter',
    'selection_amount': 30, 'RD': 1, 'special_cls' : 'none', 'parallel': 1, 'patience': -1, 'scheduler_factor': 0.955, 'q_stride': 1, 'augmentation_prob' : 1,
...
exp_config = {
    ...
    'pixels'                : 64,
    'experiment_name'       : 'selformer_results/ExperimentsForThesis/12_2_SelFormer_Second_64px',
    'experiment_id'         : 'selformer_results/ExperimentsForThesis/12_2_SelFormer_Second_64px',
    'variant'               : 'selformer',
    'B'                     : 256,
...
all_iter = {  }
data_iter = {  }
m2_iter = { 'learning_rate': [0.00125], 'dropout': [0.175] } 
graph_columns = ['q_config', 'test_auc']

df_results = make_experiment_selformer(exp_config, p1, data, p2, all_iter = all_iter, data_iter = data_iter, m2_iter= m2_iter, graph_columns = graph_columns)
