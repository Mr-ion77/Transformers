...
p1 = {
    ...
    '1_quantum' : False, '1_num_head': 4, '1_Attention_N' : 2, '1_num_transf': 1, '1_mlp_size': 20, '1_patch_size': 8, '1_weight_decay': 1e-5, '1_attention_selection': 'filter', 
    '1_selection_amount': 30, '1_RD': 1,  '1_special_cls' : 'none', '1_parallel': 1, '1_patience': -1, 
...
p2 = {
    ...
    'quantum' : False, 'num_head': 64, 'Attention_N' : 2, 'num_transf': 2, 'mlp_size': 6, 'patch_size': 8, 'weight_decay': 1e-4, 'attention_selection': 'filter',
...
exp_config = {
    ...
    'pixels'                : 64,
    'experiment_name'       : 'selformer_results/ExperimentsForThesis/12_2_SelFormer_Third_64px_mlp_size',
    'experiment_id'         : 'selformer_results/ExperimentsForThesis/12_2_SelFormer_Third_64px_mlp_size',
    'variant'               : 'selformer',
    'B'                     : 256,
...
all_iter = {  }
data_iter = {  }
m2_iter = { 'mlp_size' : [4, 8, 12, 16] } 
graph_columns = ['q_config', 'mlp_size', 'test_auc']
...
table_dir = Path(exp_config['experiment_id'] + "/aggregated_tables")
