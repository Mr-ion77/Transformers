...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/3_5_Classical_Mods_Compounding',
        'experiment_name': '3_5_Classical_Mods_Compounding',
        'B': 256,
        'N': 125, # Num epochs
        'num_experiments': 30,
        'num_classes': 7,
    ...
    model_iter = {
        'parallel' : [ 2, 3], 'selection_amount' : [15, 30, 49], 'q_stride': [1, 4], 'special_cls' : ['false', 'full_projection', 'partial_projection', 'replace_attention'],
        'dropout' : [0.175, 0.275]
    }

    graph_columns = ['parallel', 'invert_selection_amount', 'q_stride', 'special_cls', 'test_auc']
