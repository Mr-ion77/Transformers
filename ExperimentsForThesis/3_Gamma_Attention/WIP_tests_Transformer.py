...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/special_cls_updated',
        'experiment_name': '3_Gamma_Attention_NQGamma_For_Others_QGamma_for_cls',
        'B': 256,
        'N': 125, # Num epochs
        'num_experiments': 50,
        'num_classes': 7,
    ...
    model_iter = {
        'special_cls': [ 'replace_attention', 'partial_projection', 'full_projection', 'false'], 'num_head': [1, 4, 8, 16]
    }

    graph_columns = ['num_head', 'special_cls', 'test_auc']
