...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/q_classifier',
        'experiment_name': '10_Quantum_Classifier',
        'B': 256,
        'N': 100, # Num epochs
        'num_experiments': 50,
        'num_classes': 7,
    ...
    model_iter = {
        'quantum_classification' : [True, False]
    }

    graph_columns = ['quantum_classification', 'test_auc']
