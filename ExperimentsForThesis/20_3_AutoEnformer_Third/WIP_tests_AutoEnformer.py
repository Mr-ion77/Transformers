...
exp_config_base = {
    'experiment_id': 'autoenformer_results/ExperimentsForThesis/third',
    'experiment_name': 'autoenformer_results/ExperimentsForThesis/third',
    'B': 256,
    'N1': 100, # Num epochs
    'N2' : 125,
    'num_experiments': 30,
...
p1 = {
    ...
    'num_head': 16, 'Attention_N' : 2, 'num_transf': [1, 1], 'mlp_size': 30, 'patch_size': 4, 'weight_decay': 1e-7, 'attention_selection': 'none', 'entangle_method' : 'CRX',
