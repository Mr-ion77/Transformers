...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/q_preprocessor_nt',
        'experiment_name': '11_Quantum_Preprocessor_NT',
        'B': 256,
        'N': 100, # Num epochs
        'num_experiments': 50,
        'num_classes': 7,
    ...
    p_base = {
        ...
        'channels_out' : [1],
        'ancilla' : 0,
        'graphs' : {'edges': [[0, 1], [1, 2], [2, 3], [3, 0], [0, 2], [1, 3]], 'weights': [w,w,w,w,w,w]},
        'entangle_method' : 'CRX', 
