...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/quantum_training_crx_training_q_stride',
        'experiment_name': 'Quantum Training CRX Training + Q Stride Experiment',
        'B': 256,
        'N': 100, # Num epochs
        'num_experiments': 20,
        'num_classes': 7,
    ...
    model_iter = {
        'quantum' : [False, True], 'U3_layers' : [0, 1, 2], 'entangling_layers' : [0, 1, 2], 'q_stride' : [1, 2, 3, 4]
    }
