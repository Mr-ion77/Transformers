...
exp_config_base = {
    'experiment_id': 'autoenformer_results/ExperimentsForThesis/first',
    'experiment_name': 'autoenformer_results/ExperimentsForThesis/first',
    'B': 256,
    'N1': 100, # Num epochs
    'N2' : 125,
    'num_experiments': 10,
...
# Hyperparams
p1 = {
    'learning_rate': 1e-2, 'hidden_size': 48, 'dropout': {'embedding_attn': 0.025, 'after_attn': 0.025, 'feedforward': 0.025, 'embedding_pos': 0.025},
    'num_head': 48, 'Attention_N' : 2, 'num_transf': [1,1], 'mlp_size': 30, 'patch_size': 4, 'weight_decay': 1e-7, 'attention_selection': 'none', 'entangle_method' : 'CRX',
    'parallel' : 1 ,'connectivity': 'king', 'RD': 1, 'patience': -1, 'scheduler_factor': 0.965, 'q_stride': 1, 'ancilla' : 0, 'special_cls' : 'false'
}
