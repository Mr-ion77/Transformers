...
if __name__ == "__main__":
    ...
    exp_config_base = {
        'experiment_id': 'transformer_results/ExperimentsForThesis/28x28/q_preprocessor_nt_SOAP',
        'experiment_name': '11_Quantum_Preprocessor_NT_SOAP',
        'B': 256,
        'N': 100, # Num epochs
        'num_experiments': 50,
        'num_classes': 7,
    ...
    graph_columns = ['channels_out', 'test_auc']
