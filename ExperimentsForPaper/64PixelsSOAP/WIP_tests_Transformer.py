...
if __name__ == "__main__":
    ...
    exp_config_base = {
        ...
        'pixels'                : 64,
        'square'                : False,
        'experiment_name'       : 'SOAP_64pixels',
        'experiment_id'         : 'transformer_results/ExperimentsForPaper/64PixelsSOAP',
        'variant'               : 'transformer',
        'B'                     : 256,
    ...
    p_base = {
        ...
        'selection_amount': 20, 'RD': 1, 'connectivity' : 'chain' ,'entangle_method' : 'CRX', 'special_cls' : 'none', 'parallel': 1, 'patience': -1, 
