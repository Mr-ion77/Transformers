...
if __name__ == "__main__":
    ...
    exp_config_base = {
        ...
        'pixels'                : 64,
        'square'                : False,
        'experiment_name'       : 'SOAP_64pixels_GammaAtt',
        'experiment_id'         : 'transformer_results/ExperimentsForPaper/64PixelsSOAP_GammaAtt',
        'variant'               : 'transformer',
        'B'                     : 256,
    ...
    p_base = {
        'learning_rate': 0.00275, 'hidden_size': 384, 'dropout': 0.285,
        ...
        'scheduler_factor': 0.985, 'q_stride': 1, 'ancilla' : 1, 'channels_out' : [4, 0, 1, 2, 3], 'augmentation_prob' : 1, 'val_train_pond' : 1,
    ...
    model_iter = {
        'selection_amount': [25], 'special_cls': ['full_projection', 'partial_projection', 'replace_attention', 'false'], 'dropout': [0.285, 0.315]
    }
