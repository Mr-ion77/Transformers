...
p2 = {
    'learning_rate': 0.00225, 'hidden_size': 48, 'dropout': 0.3,
...
data_iter = { '1_channels_out' : [ king_measurers[ -1 ] ], '1_flatten_extra_channels':[ False, True] }
m2_iter = {'dropout' : [0.125, 0.225, 0.325, 0.425], 'len_channels_scaler': [0,  2,  4] } 
