...
p2 = {
    ...
    'quantum' : False, 'num_head': 16, 'Attention_N' : 2, 'num_transf': 1, 'mlp_size': 3, 'patch_size': 4, 'weight_decay': 1e-4, 'attention_selection': 'filter',
    'selection_amount': 15, 'RD': 1, 'special_cls' : 'none', 'parallel': 1, 'patience': -1, 'scheduler_factor': 0.955, 'q_stride': 1, 'augmentation_prob' : 0,
...
exp_config = {
    ...
    'pixels'                : 28,
    'experiment_name'       : 'selformer_results/ExperimentsForThesis/First',
    'experiment_id'         : 'selformer_results/ExperimentsForThesis/First',
    'variant'               : 'selformer',
    'B'                     : 256,
...
all_iter = {  }
data_iter = {  }
m2_iter = {  'quantum' : [ True, False ], 'num_head': [4, 16, 48], 'q_stride' : [1, 3, 5, 7] } 
