...
p1 = {
    ...
    '1_scheduler_factor': 0.985, '1_q_stride': 1, '1_ancilla' : 0, '1_channels_out' : king_measurers[ -1 ], '1_augmentation_prob' : 1, '1_val_train_pond' : 1,
...
exp_config = {
    ...
    'pixels'                : 28,
    'experiment_name'       : 'Concatenate Original 4x4 Patches with 3x3 Kernel',
