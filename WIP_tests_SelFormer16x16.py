...
exp_config = {
    ...
    'pixels'                : 224,
    'experiment_name'       : 'Resolution224/32x32patches/kernel3x3 Selformer',
    'experiment_id'         : 'resolution224/32x32patches/kernel3x3/dropout_lr',
    'variant'               : 'selformer',
    'B'                     : 256,
    'special_batch_for_data': True,
...
all_iter = {  }
data_iter = {  }
m2_iter = { 'learning_rate': [ 2.5e-5, 2.5e-4 ], 'dropout' :  [0.525, 0.625, 0.725]  } 
