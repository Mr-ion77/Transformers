...
# Hyperparams
p1 = {
    '1_learning_rate': 0.00025, '1_hidden_size': 147, '1_dropout': 0.275,
    ...
    '1_selection_amount': 8, '1_RD': 1, '1_connectivity' : 'king' ,'1_entangle_method' : 'CRX', '1_special_cls' : 'none', '1_paralel': 1, '1_patience': -1, 
...
p2 = {
    'learning_rate': 0.00025, 'hidden_size': 147, 'dropout': 0.275,
    ...
    'selection_amount': 8, 'RD': 1, 'special_cls' : 'none', 'paralel': 2, 'patience': -1, 'scheduler_factor': 0.975, 'q_stride': 1, 'augmentation_prob' : 0,
...
exp_config = {
    ...
    'experiment_id'         : 'final_stand/3x3/dropout_channels/extra_patches/7x7patches/concatenate_original',
    'variant'               : 'selformer',
    'B'                     : 256,
...
all_iter = {  }
data_iter = { 'concatenate_original'  : [True, False]  }
m2_iter = { 'learning_rate': [2.5e-5] } 
graph_columns = ['q_config', 'concatenate_original', 'test_auc']
